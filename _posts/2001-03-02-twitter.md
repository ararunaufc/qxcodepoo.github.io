...
class User:
    # como eh estático, todos os usuário 
    # vão usar a mesma variável para gerar o id
    static _nextIdTw = 0;
    ...
    def twittar(msg):
        # crie o objeto tweet usando a var _nextidTw
        # incremente o contador do prox tweet
