...
- **[2.0 P] Definir nome**
    - O contato inicia com nome "vazio"
    - Definir o nome deve ser passado como parâmetro.
- **[2.0 P] Inserir telefones no contato** 
    ...
    - Adapte o print para apresentar os celulares de forma indexada.
...
- **[2.0P] Processando números de telefone
    ...
    - Se o telefone inválido estiver na operação em lote, apenas ignore e não insira.
